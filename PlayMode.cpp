...
{
	//text_generator
	text_generator.load_font("times_new_roman.ttf");
	text_generator.reshape("database", glm::vec2(100,100), glm::vec3(1.0,0.0,0.0), 10);
...
void PlayMode::draw(glm::uvec2 const &drawable_size)
{
	...
	for (size_t i = 0; i < text_generator.characters.size(); ++i)
	{
		...
		glBindVertexArray(text_generator.VAO);
		...
		glBindBuffer(GL_ARRAY_BUFFER, text_generator.VBO);
